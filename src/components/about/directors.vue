<template>
    <div class="container bg-jungle py-[102px] pb-[110px] px-[24px] xl:px-[165px] overflow-hidden relative">
        ...
        <div class="absolute top-0 left-0 hidden md:block md:h-[150px] xl:h-[200px]">
            <img src="../../assets/d-bg.svg" alt="backround">
        </div>
        <div class="absolute top-0 left-0 block md:hidden">
            <img src="../../assets/d-bg2.svg" alt="backround">
        </div>
        <div class="absolute bottom-0 right-0 h-[100px]">
            <img src="../../assets/d-bg3.svg" alt="backround">
        </div>
    </div>
</template>
<script>
